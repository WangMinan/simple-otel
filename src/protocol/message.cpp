...
std::string
serialize_headers(std::unordered_map<std::string, std::string> headers);

std::unordered_map<std::string, std::string>
deserialize_headers(const std::string &serialized_headers);
namespace protocol {
Message::Message(
...
void Message::RemoveHeader(std::string key) { this->headers.erase(key); }
...
std::unordered_map<std::string, std::string> &Message::GetHeaders() {
  return this->headers;
}
} // namespace protocol
